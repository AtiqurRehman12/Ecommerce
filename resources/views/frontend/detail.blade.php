            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="count form-control bg-secondary text-center" value="1">
                        <div class="input-group-btn">
                    ...
                    <button class="btn btn-primary cart px-3" data-id="{{ $product->id }}"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                </div>
            </div>
        </div>
        <div class="row px-xl-5">
